...
function Header() {
    return (
        <div className="">
            <Navbar expand="lg" className="bg-white px-3 px-lg-4 shadow gradient-border">
                ...
                >
                    ...
                    <Offcanvas.Body className='px-3'>
                        <Nav className="justify-content-end flex-grow-1 pe-3 gap-2">
                            <NavLink
                                to="/"
                                className="border text-center px-2 py-1 fw-bold text-white navbar_menu rounded text-decoration-none"
                            >
                                Home
                            </NavLink>
                            <NavLink
